...
<table>
    ...
    <tr>
        <td colspan="2">
            ...
            <a href="./view/boardReplyInsert.jsp?id=${boardData.id}&pid=${boardData.pid}&depth=${boardData.depth}&porder=${boardData.porder}&boardSubject=${boardData.subject}">[답글쓰기]</a>
